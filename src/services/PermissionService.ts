...
export const showPermissionRationale = (): void => {
  const rationale = 
    'ic4u needs camera and microphone access for:\n\n' +
  ...
  AccessibilityService.announce(
    'ic4u needs camera and microphone access for voice commands and product identification.',
    { delay: 300 }
  );
...
export const openSettings = async (): Promise<void> => {
  try {
    ...
    const message = 'Could not open Settings. Please open Settings app manually and enable permissions for ic4u.';
